...
void update()
{
    ...
    g_translation_lumine.x = LUMINE_RADIUS_FROM_CENTER * cos(g_lumine_previous_frames) - 1.0f;
    g_translation_lumine.y = LUMINE_RADIUS_FROM_CENTER * sin(g_lumine_previous_frames);
